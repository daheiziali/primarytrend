...
const logicTabs = ['结构回归', 'POC承接', '偏离观察', '低量通过'];
        ...
        <div className="logic-wrap">
          ...
          <div className="logic-panel">
            <div className="logic-copy">
              <div className="logic-badge">绿色区域：承接观察区 / 橙色曲线：POC主成交区</div>
              <h3>价格回到主成交区，观察是否出现承接反应。</h3>
              <p>
                当回归中线保持抬升，价格回到 POC 或 -1SD 附近时，
                这里不是简单的“价格便宜”，而是趋势结构里的高换手观察区。
              </p>
            ...
            <div className="logic-charts">
              <div className="mini-chart bullish-chart">
                ...
                <div className="callout callout-a">靠近POC后成交增强，观察承接反馈</div>
              </div>
              <div className="mini-chart bearish-chart">
                ...
                <div className="callout callout-b">离开主成交区后，再靠近POC观察受压反馈</div>
              </div>
            </div>
          </div>
        </div>
